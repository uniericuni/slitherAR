...
struct WebCamDeviceU5BU5D_t699707851  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) WebCamDevice_t1687076478  m_Items[1];

public:
	inline WebCamDevice_t1687076478  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline WebCamDevice_t1687076478 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, WebCamDevice_t1687076478  value)
	{
		m_Items[index] = value;
	}
};
...
// UnityEngine.MeshRenderer[]
struct MeshRendererU5BU5D_t663355440  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) MeshRenderer_t1217738301 * m_Items[1];

public:
	inline MeshRenderer_t1217738301 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline MeshRenderer_t1217738301 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, MeshRenderer_t1217738301 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
